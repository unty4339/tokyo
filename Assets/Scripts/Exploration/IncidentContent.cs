...
namespace MonsterBattleGame
{
    ...
    public class IncidentContent
    {
        ...
        public Transform CreateChildObjects(Transform parent)
        {
            if (parent == null)
            {
                Debug.LogError("[IncidentContent] parent is null");
                return null;
            }
        ...
        public void OnActionSelected(IncidentAction action, IncidentProcess process)
        {
            if (action == null)
            {
